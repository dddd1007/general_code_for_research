...
log_folder = '/Users/eXrld/OneDrive - PsychoR/PhD_work/Behavioral_Experiment/Data_Analysis/group_analysis/valid_color_effect/R-W/data';

for blocknum = 1:3
    
    match_pattern = strcat('*Block', num2str(blocknum), '.log')
    filenames = dir(match_pattern)

    subject_files = {filenames.name} ;

    con_names = {'SpaceCon-ColorCon','SpaceCon-ColorInC','SpaceInC-ColorCon','SpaceInC-ColorInC'};

    results_name='Ratio_EEG';
    ...
    %
    %%%%%%%%%%%%%%%%%%%%%%%%%%
    for nfile = 1:numel(subject_files)
        
        
        subject_files{nfile}
        
        [a b c d e f g h i j k l m n o p] = textread(subject_files{nfile}, '%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s');
        ...
        subjects_data_sequential{nfile} = data_response_sequential;
        ...
        if fMRI
            ...
            subjects_onset{nfile} ={f_event, f_stimtype, f_time, f_rsptype,  onset'};
    ...
    for nsub=1:length(subjects_data_sequential)
        ...
        subjects_data{nsub}.subname = subject_files{nsub}(1:end-4);
    ...
    if RTD
        for nsub=1:length(subjects_data)
            ...
            for ncond=1:length(con_names)
                ...
                %generate four quartiles bin
                
                %raw RT
                QRT = ling_quartile(RTD_subjects(nsub).conditions(ncond).sortRT);
                
                I_Q(1) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT<QRT(1)));
                I_Q(2) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT<QRT(2)));
                I_Q(3) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT<QRT(3)));
                
                %index of four bins
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin{1}=[1:I_Q(1)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin{2}=[I_Q(1)+1:I_Q(2)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin{3}=[I_Q(2)+1:I_Q(3)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin{4}=[I_Q(3)+1:length(RTD_subjects(nsub).conditions(ncond).sortRT)];
                
                RTD_subjects(nsub).conditions(ncond).TR{1} = RTD_subjects(nsub).conditions(ncond).sortTR(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{1});
                RTD_subjects(nsub).conditions(ncond).TR{2} = RTD_subjects(nsub).conditions(ncond).sortTR(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{2});
                RTD_subjects(nsub).conditions(ncond).TR{3} = RTD_subjects(nsub).conditions(ncond).sortTR(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{3});
                RTD_subjects(nsub).conditions(ncond).TR{4} = RTD_subjects(nsub).conditions(ncond).sortTR(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{4});
                
                %mean of four bins
                RTD_subjects(nsub).conditions(ncond).mean_Bins(1) = mean(RTD_subjects(nsub).conditions(ncond).sortRT(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{1}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins(2) = mean(RTD_subjects(nsub).conditions(ncond).sortRT(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{2}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins(3) = mean(RTD_subjects(nsub).conditions(ncond).sortRT(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{3}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins(4) = mean(RTD_subjects(nsub).conditions(ncond).sortRT(RTD_subjects(nsub).conditions(ncond).I_Q_Bin{4}));
                
                %
                %raw RT removing outliers
                %
                QRT = ling_quartile(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier);
                
                I_Q(1) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier<QRT(1)));
                I_Q(2) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier<QRT(2)));
                I_Q(3) = max(find(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier<QRT(3)));
                
                %index of four bins
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{1}=[1:I_Q(1)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{2}=[I_Q(1)+1:I_Q(2)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{3}=[I_Q(2)+1:I_Q(3)];
                RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{4}=[I_Q(3)+1:length(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier)];
                
                RTD_subjects(nsub).conditions(ncond).TR_rm_outlier{1} = RTD_subjects(nsub).conditions(ncond).sortTR_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{1});
                RTD_subjects(nsub).conditions(ncond).TR_rm_outlier{2} = RTD_subjects(nsub).conditions(ncond).sortTR_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{2});
                RTD_subjects(nsub).conditions(ncond).TR_rm_outlier{3} = RTD_subjects(nsub).conditions(ncond).sortTR_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{3});
                RTD_subjects(nsub).conditions(ncond).TR_rm_outlier{4} = RTD_subjects(nsub).conditions(ncond).sortTR_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{4});
                
                %mean of four bins
                RTD_subjects(nsub).conditions(ncond).mean_Bins_rm_outlier(1) = mean(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{1}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins_rm_outlier(2) = mean(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{2}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins_rm_outlier(3) = mean(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{3}));
                RTD_subjects(nsub).conditions(ncond).mean_Bins_rm_outlier(4) = mean(RTD_subjects(nsub).conditions(ncond).sortRT_rm_outlier(RTD_subjects(nsub).conditions(ncond).I_Q_Bin_rm_outlier{4}));
    ...
    if Gratton
        ...
        for nsub=1:length(subjects_data_sequential)
            Gratton_subjects(nsub).subname = subject_files{nsub}(1:end-4);
    ...
    fid = fopen(['Results_Stat_', results_name, num2str(blocknum),'.csv'], 'w');
    ...
    if Repetition
        fid = fopen(['Results_Repetition_' results_name num2str(blocknum) '.csv'], 'w');
    ...
    if part > 1
        fid = fopen(['Results_Stat_Parts_Con_' results_name num2str(blocknum) '.csv'], 'w');
        ...
        fid = fopen(['Results_Stat_Parts_Time_' results_name num2str(blocknum) '.csv'], 'w');
    ...
    if RTD
        ...
        fid = fopen(['Results_RT_Distribution_' results_name num2str(blocknum) '.csv'], 'w');
        ...
        if fMRI_RTD
            fid = fopen(['fMRI_Stimonset_RTD_' results_name num2str(blocknum) '.csv'], 'w');
            %header
    ...
    if Gratton
        ...
        fid = fopen(['Results_Gratton_' results_name num2str(blocknum) '.csv'], 'w');
        ...
        if fMRI_Gratton
            ...
            fid = fopen(['fMRI_Stimonset_Gratton_' results_name num2str(blocknum) '.csv'], 'w');
            %header
            fprintf(fid, 'Stim Onset\n\n');
    ...
    if fMRI       
        ...
        fid = fopen(['fMRI_stimonset_' results_name num2str(blocknum) '.csv'], 'w');
        ...
        if part > 1
            ...
            fid = fopen(['fMRI_stimonset_Parts_Con_' int2str(part) '_' results_name num2str(blocknum) '.csv'], 'w');
            for nsub=1:length(subjects_data)
            ...
            %time parts
            fid = fopen(['fMRI_stimonset_Parts_Time_' int2str(part) '_' results_name num2str(blocknum) '.csv'], 'w');
            for nsub=1:length(subjects_data)
