...
log_folder = 'C:\Users\eXrld\OneDrive - PsychoR\PhD_work\Behavioral_Expriment\Project2_EstimateP_S&V\data_analysis_project2\analysis_in_matlab';

filenames = dir('*block3.log')

subject_files = {filenames.name} ;

con_names = {'red_left','red_right','green_left','green_right'};
